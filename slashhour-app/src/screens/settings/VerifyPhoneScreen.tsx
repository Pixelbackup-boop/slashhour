/**
 * VerifyPhoneScreen
 * Phone verification code input screen
...
export default function VerifyPhoneScreen({ navigation, route }: VerifyPhoneScreenProps) {
  ...
  const handleVerify = async () => {
    ...
    try {
      await verificationApi.verifyPhoneCode(verificationCode);
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: 'Code Resent',
        text2: `A new verification code has been sent to ${phone}`,
        position: 'bottom',
      });
      ...
      <View style={styles.content}>
        ...
        <View style={[styles.infoBox, { backgroundColor: colors.info + '10' }]}>
          <Text style={[styles.infoText, { color: colors.textSecondary }]}>
            💡 Didn't receive the code? Check for SMS delivery delays or try resending.
          </Text>
        </View>
      </View>
    </View>
